 ...
 * This module sets up the Firebase Admin SDK using credentials from environment variables.
 * It exports initialized Firestore and Auth instances for use in the application.
 * Note: Ensure that the following environment variables are set:
 * - FIREBASE_PROJECT_ID
 * - FIREBASE_CLIENT_EMAIL
 * - FIREBASE_PRIVATE_KEY
 * The private key should be provided as a string with escaped newlines (\\n) if necessary.
 */
